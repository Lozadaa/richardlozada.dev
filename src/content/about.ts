...
export const aboutParagraphs: Record<Locale, string[]> = {
  ...
  es: [
    ...
    "Fuera de la oficina sigo construyendo — TreeHealth, Vzla Terremoto Info, FlareRead, dexteria. Me gusta crear productos que ayuden a las personas en el día a día, y eso viene de lejos: a los 17, antes de empezar mi carrera, creé junto a un amigo «Abastece Combustible», una app de disponibilidad de gasolineras que usaron más de 10.000 personas en Venezuela — salió en prensa y TV:",
  ],
};
