...
export const aboutParagraphs: Record<Locale, string[]> = {
  en: [
    ...
    "Today I'm a Technical Lead at Openbank (Grupo Santander), where I lead the security vertical's frontend end-to-end, from architecture and code to mentoring the team. Getting here meant building for brands like LATAM Airlines, Cencosud and Falabella.",
    "Outside the office I keep shipping: %PROJECTS%. I like building products that help people in their day-to-day, and that goes way back: at 17, before my career even started, I co-built “Abastece Combustible”, a gas-station availability app used by over 10,000 people. It made press and TV:",
  ],
  es: [
    ...
    "Hoy soy Technical Lead en Openbank (Grupo Santander), donde lidero el frontend del vertical de seguridad de punta a punta, desde la arquitectura y el código hasta el mentoring del equipo. Llegar hasta aquí significó construir para marcas como LATAM Airlines, Cencosud y Falabella.",
    "Fuera de la oficina sigo construyendo: %PROJECTS%. Me gusta crear productos que ayuden a las personas en el día a día, y eso viene de lejos: a los 17, antes de empezar mi carrera, creé junto a un amigo «Abastece Combustible», una app de disponibilidad de gasolineras que usaron más de 10.000 personas. Salió en prensa y TV:",
  ],
};
