...
export const aboutParagraphs: Record<Locale, string[]> = {
  ...
  es: [
    ...
    "Fuera de la oficina sigo construyendo: TreeHealth, un mapa colaborativo de salud familiar; Vzla Terremoto Info, una PWA humanitaria para emergencias en Venezuela; FlareRead, un lector de EPUB open-source; y dexteria, un ejecutor de proyectos con IA. Me gusta crear productos que ayuden de una u otra forma a las personas en el día a día.",
